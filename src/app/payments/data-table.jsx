 ...
 */
export function DataTable({ columns, data ,setSelectedDate,selectedDate}) {
  ...
  const table = useReactTable({
    data,
   columns: columns(setDrawerOpen, setSelectedRow), // 🧠 pass drawer setters
  ...
  return (
    <div>
      {/* Filter + Calendar */}
      <div className="flex flex-row justify-between py-4 gap-2 items-end">
        <Input
          ...
          className="lg:max-w-sm max-w-[240px]"
        />

        <div>
          <h1 className="text-sm font-bold text-end pr-2 mb-1 ">
